      ...
      <Container maxWidth="lg">
        ...
        <Card className="section">
          ...
          <CardContent className="section-content">
            <p>
              We compare the probability that a model generate one of the
              expected outputs when the subjects of the input are female and
              when they are male. The given number is the relative probability
              (compared to the biggest of the two probabilities).
            </p>
            <p>Data:</p>
            <ul>
        ...
        <Card className="section">
          ...
          <CardContent className="section-content">
            <p>
              Applying RLACE or INLP to intermediate activations slightly
              reduces the bias of the model. But it works better and generalize
              a bit more to the validation set (the double bind sociology
              experiment) when editing is done in the middle of the network,
              where the network probably has a crisper representation of "male"
              and "female".
            </p>
            <Grid container>
        ...
        <Card className="section">
          ...
          <CardContent className="section-content">
            <p>
              ...
              between male and female with a rank-8 projection, we found that,
              no matter where the projection is done, and how many dimensions
              are removed, model bias isn't eliminated.
            </p>
            <Grid container>
              <Grid item xs={12} md={6}>
                <Image name="rlace_8d_layer" />
        ...
        <ul>
          ...
          <li>
            ...
            activation space. This requires a high degree of independence
            between directions, which is not exactly the case: Anthropic showed
            in their{" "}
            <a
            ...
            . This suggests that other kinds of projection - such as projection
            on a cone - might be able to remove relevant information about the
            target concepts while keeping unrelated concepts intact.
          </li>
        </ul>
